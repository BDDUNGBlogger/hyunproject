        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.querySelector('.update-chart').addEventListener('click', function () {
                ...
                selectedRows.forEach(function (checkbox) {
                    ...
                    var year = row.cells[1].innerText;
                    var label = city + ' ' + year;
            ...
            function updateChart(data) {
                ...
                temperatureBarChart.data.labels = labels;
                temperatureBarChart.data.datasets[0].data = temperatures;
...
<body>
 <jsp:include page="/WEB-INF/views/admin/sidebar.jsp" />
    ...
    <div class="details">
        ...
        <input type="text" id="search-temperature" placeholder="검색..." oninput="filterTable('details-content-temperature', this.value)">
        <div id="details-content-temperature">
            <table class="menubar" data-type="기온">
                <thead class="menuthead">
                    <tr>
                        <th class="left"><button class="sort-button" data-column="0">기록 ID</button></th>
                        <th><button class="sort-button" data-column="1">위치</button></th>
                        <th><button class="sort-button" data-column="2">날짜</button></th>
                ...
                <tbody>
                    <c:forEach var="temp" items="${temper}">
                        <tr>
                            <td>${temp.tempweatherID}</td>
                            <td>${temp.city}</td>
                            <td>${temp.years}</td>
                            <td>${temp.season}</td>
                            <td>${temp.figures}</td>
